...
def upload_to_chromadb(
    ...
    for index, chunk in enumerate(chunks):
        ...
        # For image types, include image path in text for embedding
        if chunk_type in ["Table", "Figure", "Picture"] and "image_path" in chunk:
        ...
        page_value = chunk.get("page") or chunk.get("page_number") or 0
